...
public class donor extends JFrame implements ActionListener{
	...
	donor()
	{
		setContentPane(new JLabel((new ImageIcon(("C:\\Users\\star\\Downloads\\img_12.jpeg.jpg")))));
		...
		JL6=new JLabel("ML");
		JL6.setFont(new Font("Trebuchet MS",Font.ROMAN_BASELINE,18));
		
		JL7=new JLabel("Contactnumber:");
		JL7.setFont(new Font("Trebuchet MS",Font.CENTER_BASELINE,20));

		JT1=new JTextField(30);
		JT1.setFont(new Font("Trebuchet MS",Font.BOLD,18));
		JT2=new JTextField(30);
		JT2.setFont(new Font("Trebuchet MS",Font.BOLD,18));
		JB2=new JButton("Back");
		JB2.setFont(new Font("Trebuchet MS",Font.BOLD,14));
JB2.setBounds(180, 530,150, 30);
add(JB2);

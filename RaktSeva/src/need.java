...
public class need extends JFrame implements ActionListener
{
    ...
    need()
    {
        setContentPane(new JLabel((new ImageIcon(("C:\\Users\\star\\Downloads\\img_18.jpeg.jpg")))));
...
//						}
                ...
                String q = "insert into need(PatientName,PatientAge,AadharID,BloodGrp,volume,contactNumber,Date) VALUES" + "('" + JT1.getText() + "'," + "'" + JT2.getText() + "'," + "'" +

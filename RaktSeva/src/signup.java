...
public class signup extends JFrame implements ActionListener {
	...
	signup(){
		...
		setContentPane(new JLabel((new ImageIcon(("C:\\Users\\star\\Downloads\\img_9.jpeg.jpg")))));
		...
		//Labels
		JL0=new JLabel("Sign Up");
		JL0.setFont(new Font("Trebuchet MS",Font.BOLD,30));
		JL0.setForeground(Color.red);

		JL1=new JLabel("Username:");
		JL1.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL2=new JLabel("Date Of Birth:");
		JL2.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL3=new JLabel("Email ID:");
		JL3.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL4=new JLabel("Address:");
		JL4.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL5=new JLabel("Phone Number:");
		JL5.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL6=new JLabel("Password:");
		JL6.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL7=new JLabel("Confirm Password:");
		JL7.setFont(new Font("Trebuchet MS",Font.BOLD,20));

		JL8=new JLabel("DD");
		JL8.setFont(new Font("Trebuchet MS",Font.BOLD,14));

		JL9=new JLabel("MM");
		JL9.setFont(new Font("Trebuchet MS",Font.BOLD,14));

		JL10=new JLabel("YYYY");
		JL10.setFont(new Font("Trebuchet MS",Font.BOLD,14));
		...
		int x=2005; //min age for blood donation is 18, hence the year 2002
		for(int i=0;i<41;i++)
		{
			x=x-1;
		...
		JL0.setBounds(360,30,230,40);
		add(JL0);
		JL1.setBounds(100,100,230,20);
		add(JL1);
		JL2.setBounds(100,160,230,20);
		add(JL2);
		JL3.setBounds(100,220,230,20);
		add(JL3);
		JL4.setBounds(100,280,230,20);
		add(JL4);
		JL5.setBounds(100,340,230,20);
		add(JL5);
		JL6.setBounds(100,400,230,20);
		add(JL6);
		JL7.setBounds(100,460,230,20);
		add(JL7);
		JL8.setBounds(600,140,100,20);
		add(JL8);
		JL9.setBounds(450,140,100,20);
		add(JL9);
		JL10.setBounds(300,140,100,20);
		add(JL10);

		JCB4.setBounds(600,100,130,25);
		add(JCB4);

		JT1.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JT1.setBounds(300,100,230,30);
		add(JT1);

		//String date[]= {"1","2","3","4","5","6","7",""
//		JT2.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JCB1.setBounds(300,160,100,30);
		add(JCB1);
		JCB2.setBounds(450,160,100,30);
		add(JCB2);
		JCB3.setBounds(600,160,100,30);
		add(JCB3);

		JT3.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JT3.setBounds(300,220,230,30);
		add(JT3);

		JT4.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JT4.setBounds(300,280,230,30);
		add(JT4);

		JT5.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JT5.setBounds(300,340,230,30);
		add(JT5);

		JP1.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JP1.setBounds(300,400,230,30);
		add(JP1);

		JP2.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JP2.setBounds(300,460,230,30);
		add(JP2);

		JB1.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JB1.setBounds(280,550,100,50);
		add(JB1);

		JB2.setFont(new Font("Trebuchet MS",Font.BOLD,15));
		JB2.setBounds(420,550,100,50);
		add(JB2);
		//UserID checker
	...
	public void actionPerformed(ActionEvent a)
	{
		...
		String query="insert into user (post,username,UserID,Address,phonenumber,password,Date) VALUES"+"("+"'"+(String)JCB4.getSelectedItem()+"' ,"+"'"+(String)JT1.getText()+"',"+"'"+(String)JT3.getText()+"'"+","+
				"'"+(String)JT4.getText()+"'"+","+"'"+(String)JT5.getText()+"'"+","+"'"+(String)JP1.getText()+"',"+"'"+d+"'"+")";
		String query2="select*from user where phonenumber='"+JT5.getText()+"'";
		String email="select*from user where UserID='"+JT3.getText()+"'";
			...
			if(a.getSource()==JB1)//button jb1 is clicked
			{
				...
				if(JP1.getText().equals(JP2.getText()))
				{
					...
					else if(wrongEmail(JT3.getText())&&JT3.getText()!=null)//checks if the email is invalid
					{
						JT3.setText("");
						//JT3=new JTextField(10);
						JOptionPane.showMessageDialog(null,"Incorrect Pattern of UserID");
					}
					else if(r1.next())

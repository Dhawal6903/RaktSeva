...
public class home_donor extends JFrame implements ActionListener {
	...
	home_donor()
	{
		setContentPane(new JLabel((new ImageIcon(("C:\\Users\\star\\Downloads\\img_13.jpeg.jpg")))));
		JL1=new JLabel("Home");
		JL1.setFont(new Font("Trebuchet MS",Font.BOLD,38));
		JL1.setForeground(Color.red);


		JB1=new JButton("Donate");
		JB1.setFont(new Font("Trebuchet MS",Font.BOLD,18));

		JB2=new JButton("ResetPassword");
		JB2.setFont(new Font("Trebuchet MS",Font.BOLD,18));

		JB3=new JButton("Reset Number");
		JB3.setFont(new Font("Trebuchet MS",Font.BOLD,18));

		JB4 = new JButton("GetID");
		JB4.setFont(new Font("Trebuchet MS",Font.BOLD,18));

		JB5=new JButton("Exit");
		JB5.setFont(new Font("Trebuchet MS",Font.BOLD,18));
	...
	public void actionPerformed(ActionEvent e) {
		...
		{JTextField JT2;
			...
			String Password=JOptionPane.showInputDialog(JT2,"Enter Password");
			...
			try {
				...
				if(r.next())
				{
					String newpass=JOptionPane.showInputDialog(JT2,"Enter New Password");
		...
		else if(e.getSource()==JB3)
		{
			...
			try {
				...
				if(r.next())
				{
					...
					{
						String q2="UPDATE user SET phonenumber="+"'"+newContact+"'"+"where UserID="+"'"+ID+"'";
						c.s.executeUpdate(q2);
		...
		else if(e.getSource()==JB4)
		{
			...
			String Password=JOptionPane.showInputDialog(JT1,"Enter Password");
			String q="select*from user where phonenumber="+"'"+ID+"'"+"AND "+"password="+"'"+Password+"'";
			ResultSet r=null;
			try {
				r=c.s.executeQuery(q);
				if(r.next())
